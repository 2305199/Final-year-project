...
public class FeatureTestController {
    ...
    public Map<String, Object> features(@RequestParam String url) throws URISyntaxException {
        ...
        out.put("tld_in_subdomain", featureExtractor.tld_in_subdomain(url));
        out.put("brand_in_subdomain", featureExtractor.brand_in_subdomain(url));
        return out;
    }
    ...
    public Map<String, Object> predict(@RequestParam String url) throws Exception {
        ...
        int tld_in_subdomain = featureExtractor.tld_in_subdomain(url);
        int brand_in_subdomain = featureExtractor.brand_in_subdomain(url);
        ...
        out.put("tld_in_subdomain", tld_in_subdomain);
        out.put("brand_in_subdomain", brand_in_subdomain);
