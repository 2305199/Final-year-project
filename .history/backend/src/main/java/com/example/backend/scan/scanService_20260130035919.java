...
import com.example.backend.chatbot.ChatbotMessage;
import com.example.backend.chatbot.ChatbotMessageRepository;
...
public class ScanService {
  ...
  private final ChatbotMessageRepository chatbotMessageRepo;
  ...
  public ScanService(ProviderConfigRepository configRepo,
                     ChatbotMessageRepository chatbotMessageRepo,
  ...
  private void saveRedditMessagesToDb(String json) {
    try {
      ...
      for (JsonNode child : children) {
        ...
        chatbotMessagesRepository.save(msg);
      }
    } catch (Exception e) {
