...
public class ScanController {
    ...
    public Mono<Void> runScan() throws Exception { // run scan and store results in database
        ...
        return urlStoreService.classifyAndStore(scanUrls).then(); // sends to ML then result from urlStoreService save
                                                                  // to database
