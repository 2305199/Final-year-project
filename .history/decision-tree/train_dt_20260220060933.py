...
def main():
    ...
    preds = model.predict(X_test) # makes predictions on the test data not training data using the trained model
    ...
    dump({"model": model, "feature_names": FEATURE_NAMES}, MODEL_OUT) # saves the trained model and the feature names to a file using joblib
