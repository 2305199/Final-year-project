...
function Home() {
  ...
  // ✅ Totals over last 10 scans (combined)
  const last10Scans = scans.slice(0, 10);
  const totalsLast10 = last10Scans.reduce(
    (acc, scan) => {
      acc.total = acc.total + scan.totalUrlsScanned || 0;
    ...
    <div className={styles.page}>
      ...
      <section className={styles.section}>
        <div className={styles.bottomGrid}>
          {/* ✅ Analytics totals across last 10 scans */}
          <div className={styles.panel}>
            <h2 className={styles.panelTitle}>Analytics</h2>

            <h3>Last 10 scans (total)</h3>
            <div className={styles.analyticsCircles}>
              <div className={styles.metric}>
                <div className={styles.circle}>{scans.totalUrlsScanned}</div>
